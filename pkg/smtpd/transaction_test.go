...
func TestTransactionWrongSequence1(t *testing.T) {
	...
	assert.Equal(t, int16(503), res.Code, "Initiated transactions MUST return response code 503 to a well-formed RCPT command")
	...
	assert.Equal(t, int16(503), res.Code, "Initiated transactions MUST return response code 503 to a well-formed DATA command")
...
func TestTransactionWrongSequence2(t *testing.T) {
	...
	assert.Equal(t, int16(503), res.Code, "In progress transactions MUST return response code 503 to a well-formed MAIL command")
...
func TestTransactionMissingRecipient(t *testing.T) {
	...
	assert.Equal(t, int16(503), res.Code, "In progress transaction with no recipients MUST return response code 503 to a well-formed DATA command")
